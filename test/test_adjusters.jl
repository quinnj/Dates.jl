...
@test Dates.tofirst(dt,Dates.Mon,of=Year) == Dates.Date(2014,1,6)
@test Dates.tofirst(dt,Dates.Tue,of=Year) == Dates.Date(2014,1,7)
@test Dates.tofirst(dt,Dates.Wed,of=Year) == Dates.Date(2014,1,1)
@test Dates.tofirst(dt,Dates.Thu,of=Year) == Dates.Date(2014,1,2)
@test Dates.tofirst(dt,Dates.Fri,of=Year) == Dates.Date(2014,1,3)
@test Dates.tofirst(dt,Dates.Sat,of=Year) == Dates.Date(2014,1,4)
@test Dates.tofirst(dt,Dates.Sun,of=Year) == Dates.Date(2014,1,5)
...
@test Dates.tolast(dt,Dates.Mon,of=Year) == Dates.Date(2014,12,29)
@test Dates.tolast(dt,Dates.Tue,of=Year) == Dates.Date(2014,12,30)
@test Dates.tolast(dt,Dates.Wed,of=Year) == Dates.Date(2014,12,31)
@test Dates.tolast(dt,Dates.Thu,of=Year) == Dates.Date(2014,12,25)
@test Dates.tolast(dt,Dates.Fri,of=Year) == Dates.Date(2014,12,26)
@test Dates.tolast(dt,Dates.Sat,of=Year) == Dates.Date(2014,12,27)
@test Dates.tolast(dt,Dates.Sun,of=Year) == Dates.Date(2014,12,28)
