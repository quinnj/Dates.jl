...
@test findin(a:Dates.DateTime(2013,1,14),dr) == [1:14]
@test findin(a:Dates.DateTime(2012,12,31),dr) == Int[]
@test isempty(a:Dates.DateTime(2012,12,31))
@test reverse(dr) == b:Dates.Day(-1):a
@test map!(x->x+Dates.Day(1),Array(DateTime,32),dr) == [(a+Dates.Day(1)):(b+Dates.Day(1))]
...
em = a:Dates.DateTime(2012,12,31)
